    ...
    function showQvitter()
    {
		...
		<html xmlns="http://www.w3.org/1999/xhtml">
			...
			<body style="background-color:<?php print QvitterPlugin::settings("defaultbackgroundcolor"); ?>">
				...
				<script type="text/javascript" src="<?php print $qvitterpath; ?>js/dom-functions.js?v=28"></script>		    	
				...
				<script type="text/javascript" src="<?php print $qvitterpath; ?>js/lan.js?v=26"></script>	
