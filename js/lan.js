...
window.l.pt_br.loginRememberMe = 'Recordar meus dados';
...
window.l.pt_br.compose = 'Criar um novo Queet...';
...
window.l.pt_br.expand = 'Abrir';
window.l.pt_br.collapse = 'Reduzir';
window.l.pt_br.details = 'Detalhes';
window.l.pt_br.expandFullConversation = 'Ver toda a conversa';
...
window.l.pt_br.replyTo = 'Responder a';
...
window.l.pt_br.posting = 'enviando';
...
window.l.pt_br.timeline = 'Linha temporal';
window.l.pt_br.publicTimeline = 'Linha temporal pública';
window.l.pt_br.publicAndExtTimeline = 'Toda a rede conhecida';
window.l.pt_br.searchVerb = 'Buscar';
window.l.pt_br.deleteVerb = 'Eliminar';
window.l.pt_br.cancelVerb = 'Cancelar';
window.l.pt_br.deleteConfirmation = 'Tem certeza que quer eliminar este queet?';
window.l.pt_br.userExternalFollow = 'Seguir';
...
window.l.pt_br.joinGroup = 'Juntar-se ao grupo';
window.l.pt_br.joinExternalGroup = 'Juntar-se ao grupo';
window.l.pt_br.isMemberOfGroup = 'Membro';
window.l.pt_br.leaveGroup = 'Abandonar grupo';
window.l.pt_br.memberCount = 'Membros';
window.l.pt_br.adminCount = 'Administradores';
window.l.pt_br.settings = 'Configuração';
...
window.l.pt_br.registerRepeatPassword = 'Verificar senha';
