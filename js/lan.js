...
window.l.gl.loginUsername = 'Nome de usuario ou enderezo de correo';
...
window.l.gl.viewMyProfilePage = 'Ver a miña páxina de perfil';
...
window.l.gl.signUp = 'Rexistrate';
window.l.gl.signUpFullName = 'Nome completo';
window.l.gl.signUpEmail = 'Correo-e';
window.l.gl.signUpButtonText = 'Registrate en {site-title}';
...
window.l.gl.xStartedFollowingYou = 'seguiute';
window.l.gl.followsYou = 'seguete';
