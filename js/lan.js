...
window.l.ca.requeetVerb = 'Requitta';
window.l.ca.favoriteVerb = 'Marca com a preferit';
window.l.ca.requeetedVerb = 'Requitta;'
window.l.ca.favoritedVerb = 'Marcat com a preferit';
window.l.ca.replyTo = 'Contesta';
window.l.ca.requeetedBy = 'Requittat per';
...
window.l.ca.xRepeatedYourQueet = 'ha requittat';
window.l.ca.xStartedFollowingYou = 't\'ha començat a seguir';
window.l.ca.followsYou = 'et segueix';
window.l.ca.FAQ = 'PMF';
window.l.ca.inviteAFriend = 'Convida-hi les amistats!';
window.l.ca.goToExternalProfile = 'Mostra el perfil complet';
window.l.ca.cropAndSave = 'Retalla i desa';
window.l.ca.showTerms = 'Llegeix les Condicions d\'Ús';
window.l.ca.ellipsisMore = 'Més';
window.l.ca.blockUser = 'Bloca {username}';
...
window.l.es.inviteAFriend           = '¡Invita a tus amistades!';
...
window.l.gl.requeetedVerb = 'Rechouchiado';
...
window.l.gl.shortmonthsJanuary = 'xan';
...
window.l.gl.mentions = 'Mencións';
window.l.gl.timeline = 'Liña temporal';
...
window.l.gl.deleteConfirmation = 'Estás seguro de querer eliminar este chío?';
window.l.gl.userExternalFollow = 'Seguir';
window.l.gl.userExternalFollowHelp = 'ID da tua conta (p.ex. usuario@dominio.net).';
...
window.l.gl.joinExternalGroup = 'Unirse ao grupo federado';
...
window.l.gl.registerRepeatPassword = 'Verificar o contrasinal';
window.l.gl.moreSettings = 'Máis opcións';
window.l.gl.otherServers = 'De maneira alternativa, podes crear unha conta noutro servidor da rede GNU social. <a href="http://federation.skilledtests.com/select_your_server.html">Comparanza</a>';
...
window.l.gl.xStartedFollowingYou = 'séguelo';
...
window.l.no.isMemberOfGroup = 'Medlem';
