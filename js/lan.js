...
window.l.ca.loginUsername = 'Nom d\'usuari o correu electrónic';
window.l.ca.loginPassword = 'Contrasenya';
window.l.ca.loginSignIn = 'Iniciar sessió';
window.l.ca.loginRememberMe = 'Recordar les meves dades';
...
window.l.ca.compose = 'Crear un nou Queet...';
window.l.ca.queetVerb = 'Quittetjar';
window.l.ca.queetsNounPlural = 'Queets';
window.l.ca.logout = 'Tancar sessió';
window.l.ca.languageSelected = 'Llengua:';
window.l.ca.viewMyProfilePage = 'Veure la meva pàgina de perfil';
window.l.ca.expand = 'Obrir';
window.l.ca.collapse = 'Reduir';
window.l.ca.details = 'Detalls';
window.l.ca.expandFullConversation = 'Veure la conversació sencera';
window.l.ca.replyVerb = 'Respondre';
window.l.ca.requeetVerb = 'Requittetjar';
window.l.ca.favoriteVerb = 'Favorit';
window.l.ca.requeetedVerb = 'Requittetjar';
window.l.ca.favoritedVerb = 'Marcat com a favorit';
window.l.ca.replyTo = 'Contesta';
window.l.ca.requeetedBy = 'Requittetjat per';
...
window.l.ca.newQueet = 'nou Queet';
window.l.ca.newQueets = 'nous Queets';
...
window.l.ca.viewMoreInConvBefore = '← Veure més en la conversa';
window.l.ca.viewMoreInConvAfter = 'Veure més en la conversa →';
...
window.l.ca.deleteConfirmation = 'Estàs segur de que vols eliminar aquest queet?';
window.l.ca.userExternalFollow = 'Segueix';
window.l.ca.userExternalFollowHelp = 'Identificador del seu compte (p.e. user@rainbowdash.net)';
...
window.l.ca.leaveGroup = 'Abandonar grup';
...
window.l.ca.welcomeHeading = 'Benvingut a Ajuda\'ns a traduir Qvitter :).';
...
window.l.ca.FAQ = 'FAQ';
window.l.ca.inviteAFriend = 'Convida als teus amics!';
window.l.ca.goToExternalProfile = 'Vés al perfil complet';
window.l.ca.cropAndSave = 'Retallar i guardar';
