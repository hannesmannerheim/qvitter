...
window.l.ca.loginRememberMe = 'Recorda les dades';
...
window.l.ca.compose = 'Crea un queet nou...';
...
window.l.ca.favoritedVerb = 'Marcat com a preferit';
window.l.ca.replyTo = 'Contesta';
window.l.ca.requeetedBy = 'Requittejat per';
window.l.ca.favoriteNoun = 'Preferit';
window.l.ca.favoritesNoun = 'Preferits';
...
window.l.ca.shortmonthsFebruary = 'febr.';
window.l.ca.shortmonthsMars = 'març';
window.l.ca.shortmonthsApril = 'abr.';
window.l.ca.shortmonthsMay = 'maig';
window.l.ca.shortmonthsJune = 'juny';
window.l.ca.shortmonthsJuly = 'jul.';
window.l.ca.shortmonthsAugust = 'ag.';
...
window.l.ca.time12am = '{time} a.m.';
window.l.ca.time12pm = '{time} p.m.';
...
window.l.ca.userExternalFollowHelp = 'Identificador del teu compte (p. ex. usuari@rainbowdash.net)';
window.l.ca.userFollow = 'Segueix';
window.l.ca.userFollowing = 'Seguint';
window.l.ca.userUnfollow = 'Deixa de seguir';
window.l.ca.joinGroup = 'Uneix-me al grup';
window.l.ca.joinExternalGroup = 'Uneix-me al grup';
...
window.l.es.userExternalFollowHelp  = 'ID de tu cuenta (p.e. user@rainbowdash.net).';
...
window.l.es.FAQ					    = 'Preguntas Frecuentes';
...
window.l.gl.loginUsername = 'Nome de usuari@ ou endereço electrónico';
window.l.gl.loginPassword = 'Contrassinal';
window.l.gl.loginSignIn = 'Iniciar sessão';
window.l.gl.loginRememberMe = 'Lembrarme';
window.l.gl.loginForgotPassword = 'Esqueceches o teu contrasinal?';
window.l.gl.notices = 'Chíos';
window.l.gl.followers = 'Seguidor@s';
window.l.gl.following = 'Seguindo';
window.l.gl.groups = 'Grupos';
window.l.gl.compose = 'Crear um novo Chío';
window.l.gl.queetVerb = 'Chíar';
window.l.gl.queetsNounPlural = 'Chíos';
window.l.gl.logout = 'Fechar sessão';
window.l.gl.languageSelected = 'Lingua:';
window.l.gl.viewMyProfilePage = 'Ver minha conta de perfil';
window.l.gl.expand = 'Abrir';
window.l.gl.collapse = 'Reducir';
window.l.gl.details = 'Detalhes';
...
window.l.gl.favoriteVerb = 'Favorito';
window.l.gl.requeetedVerb = 'Rechiado';
window.l.gl.favoritedVerb = 'Marcado como favorito';
window.l.gl.replyTo = 'Responder a';
window.l.gl.requeetedBy = 'Rechouchiado por {requeeted-by}';
window.l.gl.favoriteNoun = 'Favorito';
window.l.gl.favoritesNoun = 'Favoritos';
window.l.gl.requeetNoun = 'Rechouchío';
window.l.gl.requeetsNoun = 'Rechouchíos';
window.l.gl.newQueet = 'novo Chío';
window.l.gl.newQueets = 'novos Chíos';
window.l.gl.longmonthsJanuary = 'janeiro';
window.l.gl.longmonthsFebruary = 'fevereiro';
window.l.gl.longmonthsMars = 'março';
window.l.gl.longmonthsApril = 'abril';
window.l.gl.longmonthsMay = 'maio';
window.l.gl.longmonthsJune = 'junho';
window.l.gl.longmonthsJuly = 'julho';
...
window.l.gl.viewMoreInConvBefore = '← Ver máis na conversa';
window.l.gl.viewMoreInConvAfter = 'Ver máis na conversa →';
window.l.gl.mentions = 'Menções';
window.l.gl.timeline = 'Linha temporal';
window.l.gl.publicTimeline = 'Liña temporal pública';
window.l.gl.publicAndExtTimeline = 'Toda a rede conhecida';
window.l.gl.searchVerb = 'Procurar';
window.l.gl.deleteVerb = 'Eliminar';
window.l.gl.cancelVerb = 'Cnacelar';
window.l.gl.deleteConfirmation = 'Estás segur@ de que queres eliminar este chío?';
window.l.gl.userExternalFollow = 'Seguir';
window.l.gl.userExternalFollowHelp = 'ID da tua conta (p.e. user@rainbowdash.net).';
window.l.gl.userFollow = 'Seguir';
window.l.gl.userFollowing = 'Seguindo';
window.l.gl.userUnfollow = 'Deixar de seguir';
window.l.gl.joinGroup = 'Unir-se ao grupo';
window.l.gl.joinExternalGroup = 'Unir-se ao grupo';
window.l.gl.isMemberOfGroup = 'Membro';
window.l.gl.leaveGroup = 'Abandonar grupo';
window.l.gl.memberCount = 'Membros';
window.l.gl.adminCount = 'Administradores';
window.l.gl.settings = 'Configuração';
window.l.gl.saveChanges = 'Gardar câmbios';
window.l.gl.linkColor = 'Cor do enlance';
window.l.gl.backgroundColor = 'Cor do fondo';
window.l.gl.newToQuitter = 'Es nov@ en {site-title}?';
window.l.gl.signUp = 'Registra-te';
window.l.gl.signUpFullName = 'Nome completo';
window.l.gl.signUpEmail = 'Endereço electrónico';
window.l.gl.signUpButtonText = 'Registra-te en {site-title}';
window.l.gl.welcomeHeading = 'Benvid@ a {site-title}';
window.l.gl.welcomeText = 'Somos unha <span id="federated-tooltip"><div id="what-is-federation">« Federación » significa que non debes ter unha conta de {site-title} para seguir os seus usuarios, estar seguido por ou communicar con eles. Podes rexistrar con calquera servidor StatusNet ou <a href="http://www.gnu.org/software/social/">GNU Social</a>, ou calquera servizo utilizando o protocolo <a href="http://www.w3.org/community/ostatus/wiki/Main_Page">OStatus</a>! Tamén non debes rexistrarse en calquera servizo para participar - simplemente instala o software GNU Social no teu propio servidor. (:</div>federación</span> de microblogueros que, como ti, estan motivados por ética e solidariedade e queren abandonar os servizos centralizados capitalistas.';
window.l.gl.registerNickname = 'Nome de usuari@';
window.l.gl.registerHomepage = 'Sítio web';
window.l.gl.registerBio = 'Biografia';
window.l.gl.registerLocation = 'Ubicação';
window.l.gl.registerRepeatPassword = 'Verificar contrassinal';
window.l.gl.moreSettings = 'Máis opções';
window.l.gl.otherServers = 'De maneira alternativa, podes crear uma conta noutro servidor';
window.l.gl.editMyProfile = 'Editar perfil';
window.l.gl.notifications = 'Notificações';
window.l.gl.xFavedYourQueet = 'marcou o teu chío como favorito';
window.l.gl.xRepeatedYourQueet = 'rechouchiou-te';
window.l.gl.xStartedFollowingYou = 'seguiu-te';
window.l.gl.followsYou = 'segue-te';
window.l.gl.FAQ = 'Preguntas Frequentes';
...
window.l.eo.longmonthsFebruary      = "februaro";
...
window.l.eo.viewMoreInConvBefore    = '← Plu legi en la konversacio';
window.l.eo.viewMoreInConvAfter     = 'Plu legi en la konversacio →';
window.l.eo.mentions                = 'Mencioj';
window.l.eo.timeline                = 'Kronologio';
window.l.eo.publicTimeline          = 'Publika kronologio';
window.l.eo.publicAndExtTimeline    = 'Kronologio de la federo-reto';
...
window.l.eo.otherServers            = 'Vi povus alternative krei konton en alia servilo';
window.l.eo.editMyProfile     	    = 'Redaktu profilon';
window.l.eo.notifications           = 'Sciigoj';
window.l.eo.xFavedYourQueet         = 'via avizo estis favorigita';
...
window.l.ast.loginUsername           = 'Nome d\'usuariu o corréu-e';
...
window.l.ast.loginForgotPassword     = '¿Escaecisti la contraseña?';
window.l.ast.notices                 = 'Queets';
window.l.ast.followers               = 'Siguidores';
window.l.ast.following               = 'Siguiendo';
window.l.ast.groups                  = 'Grupos';
window.l.ast.compose                 = 'Crear un Queet nuevu...';
window.l.ast.queetVerb               = 'Quittiar';
window.l.ast.queetsNounPlural        = 'Queets';
window.l.ast.logout                  = 'Zarrar sesión';
window.l.ast.languageSelected        = 'Llingua:';
window.l.ast.viewMyProfilePage       = 'Ver la mio páxina de perfil';
window.l.ast.expand                  = 'Abrir';
window.l.ast.collapse                = 'Contrayer';
window.l.ast.details                 = 'Detalles';
window.l.ast.expandFullConversation  = 'Ver la conversación entera';
window.l.ast.replyVerb               = 'Responder';
window.l.ast.requeetVerb             = 'Requittiar';
window.l.ast.favoriteVerb            = 'Favoritu';
window.l.ast.requeetedVerb           = 'Requittiáu';
window.l.ast.favoritedVerb           = 'Marcáu como favoritu';
window.l.ast.replyTo                 = 'Responder a';
window.l.ast.requeetedBy             = 'Requittiáu por {requeeted-by}';
window.l.ast.favoriteNoun            = 'Favoritu';
window.l.ast.favoritesNoun           = 'Favoritos';
window.l.ast.requeetNoun             = 'Requeet';
window.l.ast.requeetsNoun            = 'Requeets';
window.l.ast.newQueet                = 'Queet nuevu';
window.l.ast.newQueets               = 'Queets nuevos';
window.l.ast.longmonthsJanuary       = "xineru";
window.l.ast.longmonthsFebruary      = "febreru";
window.l.ast.longmonthsMars          = "marzu";
window.l.ast.longmonthsApril         = "abril";
window.l.ast.longmonthsMay           = "mayu";
window.l.ast.longmonthsJune          = "xunu";
window.l.ast.longmonthsJuly          = "xunetu";
window.l.ast.longmonthsAugust        = "agostu";
window.l.ast.longmonthsSeptember     = "setiembre";
window.l.ast.longmonthsOctober       = "ochobre";
window.l.ast.longmonthsNovember      = "payares";
window.l.ast.longmonthsDecember      = "avientu";
window.l.ast.shortmonthsJanuary      = "xin";
window.l.ast.shortmonthsFebruary     = "feb";
window.l.ast.shortmonthsMars         = "mar";
window.l.ast.shortmonthsApril        = "abr";
window.l.ast.shortmonthsMay          = "may";
window.l.ast.shortmonthsJune         = "xun";
window.l.ast.shortmonthsJuly         = "xnt";
window.l.ast.shortmonthsAugust       = "ago";
window.l.ast.shortmonthsSeptember    = "set";
window.l.ast.shortmonthsOctober      = "och";
window.l.ast.shortmonthsNovember     = "pay";
window.l.ast.shortmonthsDecember     = "avi";
window.l.ast.time12am                = '{time} AM';
window.l.ast.time12pm                = '{time} PM';
window.l.ast.longDateFormat          = '{time24} - {day} {month} {year}';
window.l.ast.shortDateFormatSeconds  = '{seconds}s';
window.l.ast.shortDateFormatMinutes  = '{minutes}min';
window.l.ast.shortDateFormatHours    = '{hours}h';
window.l.ast.shortDateFormatDate     = '{day} {month}';
window.l.ast.shortDateFormatDateAndY = '{day} {month} {year}';
window.l.ast.now                     = 'agora';
window.l.ast.posting                 = 'unviando';
window.l.ast.viewMoreInConvBefore    = '← Ver más na conversación';
window.l.ast.viewMoreInConvAfter     = 'Ver más na conversación →';
window.l.ast.mentions                = 'Menciones';
window.l.ast.timeline                = 'Llinia temporal';
window.l.ast.publicTimeline          = 'Llinia temporal pública';
window.l.ast.publicAndExtTimeline    = 'Tola rede conocida';
window.l.ast.searchVerb              = 'Guetar';
window.l.ast.deleteVerb              = 'Desaniciar';
window.l.ast.cancelVerb              = 'Encaboxar';
window.l.ast.deleteConfirmation      = '¿Daveres que quies desaniciar esti queet?';
window.l.ast.userExternalFollow      = 'Siguir';
window.l.ast.userExternalFollowHelp  = 'ID de la cuenta (p.ex. user@rainbowdash.net).';
window.l.ast.userFollow              = 'Siguir';
window.l.ast.userFollowing           = 'Siguiendo';
window.l.ast.userUnfollow            = 'Dexar de siguir';
window.l.ast.joinGroup               = 'Xunise al grupu';
window.l.ast.joinExternalGroup       = 'Xunise al grupu';
window.l.ast.isMemberOfGroup         = 'Miembru';
window.l.ast.leaveGroup              = 'Dexar el grupu';
window.l.ast.memberCount             = 'Miembros';
window.l.ast.adminCount              = 'Alministradores';
window.l.ast.settings                = 'Axustes';
window.l.ast.saveChanges             = 'Guardar cambeos';
window.l.ast.linkColor               = 'Color del enllaz';
window.l.ast.backgroundColor         = 'Color de fondu';
window.l.ast.newToQuitter            = '¿Yes nuevu en {site-title}?';
window.l.ast.signUp                  = 'Rexístrate';
window.l.ast.signUpFullName          = 'Nome completu';
